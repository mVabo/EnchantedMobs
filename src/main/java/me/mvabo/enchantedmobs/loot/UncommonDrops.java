...
public class UncommonDrops {
    ...
    public UncommonDrops(Entity e, EntityDeathEvent event) {
        ArrayList<ItemStack> items = new ArrayList<ItemStack>();
        items.clear();
        event.getDrops().clear();
        if(e.getName().equals(plugin.getConfig().getString("cannibal_name"))) {
            for (String key : loot.getLootConfig().getStringList("uncommon_cannibal_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_illusioner_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_tribalHunter_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_fallenBarbarian_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_stalker_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_sandElemental_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_zombieThief_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_ghostOfTheTemplar_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_possessedLumberjack_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_sunkenPirate_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("uncommon_waterElemental_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
