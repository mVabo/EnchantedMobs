...
public class LegendaryDrops {
    ...
    public LegendaryDrops(Entity e, EntityDeathEvent event) {
        ArrayList<ItemStack> items = new ArrayList<ItemStack>();
        items.clear();
        event.getDrops().clear();
        if(e.getName().equals(plugin.getConfig().getString("cannibal_name"))) {
            for (String key : loot.getLootConfig().getStringList("legendary_cannibal_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_illusioner_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_tribalHunter_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_fallenBarbarian_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_stalker_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_sandElemental_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_zombieThief_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_ghostOfTheTemplar_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_possessedLumberjack_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_sunkenPirate_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
            ...
            for (String key : loot.getLootConfig().getStringList("legendary_waterElemental_drops")) {
                ItemStack item;
                if(key.startsWith("c")) {
                    item = new ItemHandler().getItem(key);
                } else {
